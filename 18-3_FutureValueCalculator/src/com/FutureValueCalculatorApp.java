...
public class FutureValueCalculatorApp extends JFrame {

    private JTextField investmentField;
    private JTextField interestRateField;
    private JTextField yearsField;
    private JTextField futureValueField;
    private JLabel investmentFieldError;
    private JLabel interestRateFieldError;
    private JLabel yearsFieldError;

    public FutureValueCalculatorApp() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        investmentFieldError = new JLabel();
        interestRateFieldError = new JLabel();
        yearsFieldError = new JLabel();
        ...
        Dimension errorDim = new Dimension(250, 20);
        investmentFieldError.setPreferredSize(errorDim);
        investmentFieldError.setMinimumSize(errorDim);
        interestRateFieldError.setPreferredSize(errorDim);
        interestRateFieldError.setMinimumSize(errorDim);
        yearsFieldError.setPreferredSize(errorDim);
        yearsFieldError.setMinimumSize(errorDim);
        ...
        panel.add(investmentFieldError, getConstraints(2,0));
        panel.add(interestRateFieldError, getConstraints(2,1));
        panel.add(yearsFieldError, getConstraints(2,2));
    ...
    private void calculateButtonClicked() {
        ...
        if (sv.isPresent(investmentField, "Monthly Investment") &&
            ...
            investmentFieldError.setText("");
            interestRateFieldError.setText("");
            yearsFieldError.setText("");
            futureValueField.setText(currency.format(futureValue));
        } else {
            if (!sv.isPresent(investmentField, "Monthly Investment") ||
                   !sv.isDouble(investmentField, "Monthly Investment")) {
                investmentFieldError.setText("Monthly Investment must be a valid number.");
            } else {
                investmentFieldError.setText("");
            }
            if (!sv.isPresent(interestRateField, "Yearly Interest Rate") ||
                    !sv.isDouble(interestRateField, "Yearly Interest Rate")) {
                interestRateFieldError.setText("Yearly Interest Rate must be a valid number.");
            } else {
                interestRateFieldError.setText("");
            }
            if (!sv.isPresent(yearsField, "Years") ||
                    !sv.isInteger(yearsField, "Years")) {
                yearsFieldError.setText("Years must be an integer.");
            } else {
                yearsFieldError.setText("");
            }
        }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ...
            JFrame frame = new FutureValueCalculatorApp();
        });
    }
}